...
export const STARTING_LOCATIONS_12: DestinationItem[] = [
  ...
  { id: "tihar_jail", name: "14. Tihar Jail Complex (Jail Road)", icon: "🏛️", area: "Janakpuri / Jail Road", badge: "High Security Hub" },
  { id: "lady_hardinge_hospital", name: "15. Lady Hardinge Medical College & Hospital", icon: "🏥", area: "Panchkuian / CP West", badge: "Super Specialty Hospital" },
];
...
): { source: string; target: string; sourceName: string; targetName: string; route: RouteResponse } | null {
